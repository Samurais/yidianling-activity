...
class Demo extends Component {
  ...
  constructor(props) {
    ...
    this.pagePicList1 = [
      {
        "name":"/src/images/activity/love/wanhui/20190311/1.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/2.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/3.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/4.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/5.png",
      }
    ];
    this.pagePicList2 = [
      {
        "name":"/src/images/activity/love/wanhui/20190311/6.png"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/7.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/8.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/9.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/10.png",
        "id":"1"
      }
    ];
    this.pagePicList3 = [
    ...
    this.pagePicList4 = [
      {
        "name":"/src/images/activity/love/wanhui/20190311/liucheng.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/about_title.png"
      }
    ];
    this.middleImg = {
    ...
    this.caseList = [
      {
        "name":"/src/images/activity/love/wanhui/20190311/case1.png"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190311/case2.png"
      }
    ];
    this.aboutList = [
      {
    ...
    this.case_title= "/src/images/activity/love/wanhui/20190311/case_title.png";
    this.target = "/love/m/20190311";
  }
  ...
  componentDidMount(){
    let _this = this;
    let eventId = "/love/wanhui/m/20190311";
  ...
  render() {
    return (
      <div className="page-love-wanhui-20190311">
        {/*banner头部*/}
