...
class Demo extends Component {
  ...
  constructor(props) {
    ...
    this.pagePicList1 = [
      {
        "name":"/src/images/activity/love/wanhui/20190318/1.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/2.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/3.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/4.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/5.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/6.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/7.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/8.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/9.png",
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/10.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/11.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/12.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/13.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/14.png",
        "id":"1"
      }
    ];
    this.pagePicList3 = [
    ...
    this.pagePicList4 = [
      {
        "name":"/src/images/activity/love/wanhui/20190318/why.png",
      }
    ];
    this.middleImg = {
    ...
    this.caseList = [
      {
        "name":"/src/images/activity/love/wanhui/20190318/10-1.png"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/10-2.png"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190318/10-3.png"
      }
    ];
    this.aboutList = [
      {
    ...
    this.about_title= "/src/images/activity/love/wanhui/20190318/about_title.png";
    this.userSay="/src/images/activity/love/wanhui/20190129/16.png";
    this.target = "/love/m/20190318";
  }
  ...
  componentDidMount(){
    let _this = this;
    let eventId = "/love/wanhui/m/20190318";
  ...
  getHtml(item,index){
    let element;
    element = item.id? (
      <a className="js_kf" key={index} href="javascript:" data-target={index == 0 ? "/love/m/20190318_banner":"/love/m/20190318_underbanner"}>
  ...
  render() {
    return (
      <div className="page-love-wanhui-20190318">
        {/*banner头部及专家列表*/}
