...
import Newbottom from '../wanhui/component/Newbottom';
...
class Demo extends Component {
  ...
  constructor(props) {
    ...
    this.pagePicList1 = [
      {
        "name":"/src/images/activity/love/wanhui/20190218/1.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190218/2.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190218/3.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190218/4.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/love/wanhui/20190218/5.png",
        "id":"1"
      }
    ]
    this.pagePicList2 = [
      {
        "name":"/src/images/activity/love/wanhui/20190218/6.png"
      },
      {
      ...
      {
        "name":"/src/images/activity/love/wanhui/20190218/7.png"
      }
    ]
    this.pagePicList3 = [
      {
  ...
  componentDidMount(){
    let _this = this;
    let eventId = "/love/wanhui/m/20190218";
  ...
  getHtml(item,index){
    ...
    element = item.id? (
      ...
      <a className="js_kf" key={index} href={this.position} data-target="/love/m/20190129_map">
        <div className="container">
          <img className="item lazy" data-original={item.name} src={this.defImg} key={index}/>
        </div>
      </a>
