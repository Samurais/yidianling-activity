...
class Demo extends Component {
  ...
  constructor(props) {
    ...
    this.pagePicList1 = [
      {
        "name":"/src/images/activity/m/beijing/2.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/3.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e1.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e2.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e3.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e4.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e5.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/e6.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/4.png",
        "id":"1"
      },
      {
        "name":"/src/images/activity/m/beijing/ni.png"
      },
    ];
    this.pagePicList2 = [
      {
        "name":"/src/images/activity/m/beijing/15.png"
      },
      {
        "name":"/src/images/activity/m/beijing/16.png"
      }
    ];
    this.pagePicList3 = [
      {
        "name":"/src/images/activity/m/beijing/mt.png"
      },
      {
        "name":"/src/images/activity/m/beijing/pic8.png"
      }
    ];
    this.topImg = {
      "name":"/src/images/activity/m/beijing/1.png"
    };
    this.honor_bg = {
      "name":"/src/images/activity/m/beijing/honor_bg.png"
    };
    this.middleImg = {
      "name":"/src/images/activity/m/beijing/middle.png"
    };
    this.honorSwiperList = [
      {
        "img":"/src/images/activity/m/beijing/honor1.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor2.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor3.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor4.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor5.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor6.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor7.png"
      },
      {
        "img":"/src/images/activity/m/beijing/honor8.png"
      }
    ];
    this.taList = [
      {
        "name":"/src/images/activity/m/beijing/ta1.png"
      },
      {
        "name":"/src/images/activity/m/beijing/ta2.png"
      },
      {
        "name":"/src/images/activity/m/beijing/ta3.png"
      }
    ];
    this.aboutList = [
      {
        "name":"/src/images/activity/m/beijing/about0.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about1.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about2.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about3.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about4.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about5.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about6.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about7.png"
      },
      {
        "name":"/src/images/activity/m/beijing/about8.png"
      }
    ];
    this.ta_title="/src/images/activity/m/beijing/13.png";
    this.defImg = "/src/images/global/lazy.png";
    this.honorText="/src/images/activity/m/beijing/honor_text.png"
  ...
  getHtml(item,index){
    let element;
    element = item.id? (
      <a className="js_kf" key={index} href="javascript:" data-target={item.id == 1 ? "/m/beijing_banner":"/m/beijing_underbanner"}>
        <div className="container">
          <img className="item lazy" data-original={item.name} src={this.defImg} key={index}/>
        </div>
      </a>
    ) :item.position ? (
      <a className="" key={index} href={this.position} data-target="/m/beijing_map">
        <div className="container">
          <img className="item lazy" data-original={item.name} src={this.defImg} key={index}/>
        </div>
      </a>
  ...
  getExpertsHTML(item, index){
    return (
      <a href="javascript:" data-id={item.id} key={index} className="js_kf" data-target="/m/beijing_expert">
  ...
  render() {
    ...
    <div>
        ...
        {/* 跳转 */}
        <Native />
        <div className="page-m-beijing">
          <div className="top-container">
            <a className="js_kf_phone" href="javascript:" data-target="/m/beijing_phone">
            ...
            <div className="swiper-container ni-swiper">
              <div className="swiper-wrapper">
                <div className="swiper-slide swiper-slide1">
                  <a className="js_kf" data-target="" href="javascript:"  data-target="/m/beijing_chat">
                    <div className="in-box">
                      <img src={this.defImg} data-src="/src/images/activity/m/beijing/ni1.png" className="js_kf swiper-lazy"/>
                    </div>
                  </a>
                </div>
                <div className="swiper-slide">
                  <a className="js_kf" data-target="" href="javascript:"  data-target="/m/beijing_chat">
                    <div className="in-box">
                      <img src={this.defImg} data-src="/src/images/activity/m/beijing/ni2.png" className="js_kf swiper-lazy"/>
                    </div>
                  </a>
                </div>
                <div className="swiper-slide">
                  <a className="js_kf" data-target="" href="javascript:"  data-target="/m/beijing_chat">
                    <div className="in-box">
                      <img src={this.defImg} data-src="/src/images/activity/m/beijing/ni3.png" className="js_kf swiper-lazy"/>
                    </div>
                  </a>
                </div>
                <div className="swiper-slide">
                  <a className="js_kf" data-target="" href="javascript:"  data-target="/m/beijing_chat">
                    <div className="in-box">
                      <img src={this.defImg} data-src="/src/images/activity/m/beijing/ni4.png" className="js_kf swiper-lazy"/>
                    </div>
                  </a>
                </div>
                <div className="swiper-slide swiper-slide5">
                  <a className="js_kf" data-target="" href="javascript:"  data-target="/m/beijing_chat">
                    <div className="in-box">
                      <img src={this.defImg} data-src="/src/images/activity/m/beijing/ni5.png" className="js_kf swiper-lazy"/>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <img className="why-bg lazy" src="/src/images/activity/m/beijing/5.png" />
          {/* 他说 */}
          ...
          <div className="bottom">
            <div className="bo1">
              <span className="span1 span-l">
                <img className="b-1" src="/src/images/activity/m/beijing/b-1.png"/>
              </span>
              <span className="span1 span-m">
                <img className="b-2" src="/src/images/activity/m/beijing/b-2.png"/>
              </span>
              <span className="span1 span-r">
                <img className="b-3" src="/src/images/activity/m/beijing/b-3.png"/>
              </span>
            </div>
            {/*<div className="bo2">*/}
              {/*<a className="" href={this.position} data-target="/m/beijing_map">*/}
