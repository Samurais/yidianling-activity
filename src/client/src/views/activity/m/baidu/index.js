...
class Page extends Component {
  constructor(props) {
    ...
    this.questList = [
      {"url": "https://static.ydlcdn.com/activity/images/activity002/ico_love.png","txt01": "情感婚姻","txt02": "恋爱、逼婚、恐婚、外遇、离婚","txt03": "2394139人已咨询"},
      {"url": "https://static.ydlcdn.com/activity/images/activity002/ico_mood.png","txt01": "情绪压力","txt02": "焦虑抑郁、失眠强迫等心理症状","txt03": "933680人已咨询"},
      {"url": "https://static.ydlcdn.com/activity/images/activity002/ico_kid.png","txt01": "孩子教育","txt02": "自闭、多动、网瘾、厌学等问题","txt03": "259490人已咨询"},
      {"url": "https://static.ydlcdn.com/activity/images/activity002/ico_work.png","txt01": "职场人际","txt02": "职业发展、同事关系工作压力等","txt03": "80916人已咨询"},
      {"url": "https://static.ydlcdn.com/activity/images/activity002/ico_develop.png","txt01": "个人成长","txt02": "内向孤僻、情绪调节、个人提升","txt03": "674685人已咨询"},
    ]
    this.swiperList = [
    ...
    return (
      <div className="page-m-zhichang">
        ...
        <div className="cont03">
          ...
          <a href="http://t.yidianling.com/baidu/experts/" className='btn1'>查看更多专家</a>
        </div>
        ...
        <div className="cont04">
          ...
          <a href="http://t.yidianling.com/baidu/recomend/" class="btn1">查看专家好评榜</a>
        </div>
        {/* 各大媒体争相报道 */}
        ...
        <div className="footer">
          <ul className="navs">
              <li><a href="/baidu/">首页</a></li>
              <li><a href="//m.yidianling.com/uc">会员中心</a></li>
              <li><a href="//m.yidianling.com/uc/orders">订单查询</a></li>
              <li><a href="//m.yidianling.com/app">下载app</a></li>
          </ul>
          <p className="txt01">客服：<a href="tel:400-114-1010" className="number">400-114-1010</a></p>
          <p className="txt02">（工作时间：早08:30-次日凌晨01:00）</p>
          <p className="txt03"><span className="win_copyright"></span>
                <span className="win_company"></span><br/>
                <span className="win_copycode"></span></p>
        </div>
        <div class="area_floatMenu">
          <a href="tel:400-114-1010" target="_self"><img src="http://static1.ydlcdn.com/mobile/images/area/server-new.png" /></a>
          <a class='kf_xinnuan' target="_self"><img src="http://static1.ydlcdn.com/mobile/images/area/online.png" /></a>
        </div>
        </div>
        )
      }
