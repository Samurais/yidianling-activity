      ...
      let {showBottom,showModal,phone}=this.state;
        return(
            <div>
              ...
              {/* 跳转 */}
              <Native />
              <div className="page-activity-qs-20190130">
                ...
                <div className="container">
                  <img className="lazy" data-original={this.pageList[1].name} src={this.defImg}></img>
                </div>
                <div className="container">
                  <img className="lazy" data-original={this.pageList[2].name} src={this.defImg}></img>
                </div>
                {!!showBottom?<div className="in-bottom"></div>:""}
                {!!showBottom?<div className="bottom-box"><div className="bottom-btn js_hmt_click" onClick={this.showModal} data-target="/qs/20190130_freecall">免费拨打解忧电话</div></div>:""}
                <Modal
                popup
                visible={showModal}
                onClose={this.closeModal}
                className="modal-page-activity-qs-20190130"
                mask={true}
                >
                  <div className="form-box">
                    <div className="input-box">
                      <input className="input1"
                      placeholder="请输入手机号" onChange={this.change.bind(this)} defaultValue={phone} name="phone" autoFocus></input>
                    </div>
                    <div className="input-box">
                      <input className="input2"
                      placeholder="请输入验证码" onChange={this.change.bind(this)} name="code"></input>
                      <div className="get-code js-code js_hmt_click" data-target="/qs/20190130_getcode">获取验证码</div>
                    </div>
                    <div className="send-btn js_hmt_click" onClick={this.submit.bind(this)} data-target="/qs/20190130_freecall">免费拨打解忧电话</div>
                    <img className="img1"src={this.pageList[4].name}></img>
                  </div>
                </Modal>
              </div>
