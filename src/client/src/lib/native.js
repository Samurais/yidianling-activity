 ...
 * @param url 页面跳转
 * ***/
native.uesrGoPage = function (url) {
  console.log('uesrGoPage');
  setTimeout(function () {
    //通用分享
    const params = {};
    params.cmd = {};
...
/***
 * 用户版-跳转到页面
 * @function userTolistenlistlink
 * ***/
native.userTolistenlistlink = function () {
  ...
  setTimeout(function () {
      ...
      params.cmd = {};
      params.cmd.params = {};
      params.cmd.action_name = 'listen_list';
      params.url = 'ydl_app';
