...
.forEach(function (method) {
  ...
  def(arrayMethods, method, function mutator () {
    ...
    // //jsperf.com/closure-with-arguments
...
var namespaceMap = {
  ...
  math: '//www.w3.org/1998/Math/MathML'
};
...
function isUnknownElement (tag) {
  ...
  if (tag.indexOf('-') > -1) {
    // //stackoverflow.com/a/28210364/1070244
    return (unknownElementCache[tag] = (
...
/* istanbul ignore if */
if (isIE9) {
  // //www.matts411.com/post/internet-explorer-9-oninput/
